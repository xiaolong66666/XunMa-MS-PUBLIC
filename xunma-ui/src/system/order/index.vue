  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="是否逾期" prop="isOverdue">
        <el-select v-model="queryParams.isOverdue" placeholder="请选择是否逾期" clearable>
          <el-option
    ...
    <el-table v-loading="loading" :data="orderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="是否逾期" align="center" prop="isOverdue">
        <template slot-scope="scope">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        isOverdue: [
          { required: true, message: "是否逾期不能为空", trigger: "change" }
        ],
        isDelete: [
